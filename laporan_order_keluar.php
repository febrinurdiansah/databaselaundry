...
<TBODY>
	<TR><TD colspan=3 height=40 ><p align="center"><b><b>DAFTAR ORDER KELUAR</b></TD></TR>
	<TR><form action="laporan_order_keluar.php" method="POST">
...
$hasil = mysql_query("SELECT * FROM transaksi,pelanggan WHERE transaksi.id_pelanggan=pelanggan.id_pelanggan and transaksi.status='1' and transaksi.tanggal_ambil LIKE '$tanggal'",$id_mysql);
if (! $hasil)
